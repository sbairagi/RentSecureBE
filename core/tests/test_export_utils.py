...
class GenerateOwnerRentReportTest(TestCase):
    def setUp(self):
        self.owner = User.objects.create_user(
            username='export_owner', email='owner@test.com',
            password='p', full_name='Owner', phone='+1'
        )
    ...
    def test_generate_report_with_data(self, mock_rent_record):
        ...
        mock_rent_record.objects.filter.return_value.select_related.return_value = [mock_rent]
