...
urlpatterns = [
    ...
    path("owner/update-bank-details/", update_owner_bank_details),
    path("owner/update-alert-preferences/", update_owner_alert_preferences),
    path("owner/reminder-time/", ReminderTimeUpdateView.as_view()),
    path("rent/payment/", create_rent_payment, name="create-rent-payment"),
    path(
        "rent/verify-payment/",
        verify_renter_rent_payment,
        name="verify-renter-rent-payment",
    ),
    path("rent/payment-callback/", razorpay_webhook),
    path(
