...
class MessageTemplateServiceTests(TestCase):
    ...
    def test_get_rent_paid_confirmation_msg_english(self):
    ...
    def test_get_rent_paid_confirmation_msg_hindi(self):
        msg = get_rent_paid_confirmation_msg(
            name="रजत",
            amount=5000,
            paid_date=date(2026, 6, 5),
    ...
    def test_get_rent_paid_confirmation_msg_marathi(self):
        msg = get_rent_paid_confirmation_msg(
            name="अमित",
            amount=5000,
            paid_date=date(2026, 6, 5),
    ...
    def test_get_rent_paid_confirmation_msg_falls_back_to_english(self):
        msg = get_rent_paid_confirmation_msg(
            name="John",
            amount=5000,
            paid_date=date(2026, 6, 5),
