...
from ..models import Unit, Caretaker, Renter, RentAgreementDraft, UnitImage, UnitDocument
...
class UnitAdmin(SimpleHistoryAdmin):
    list_display = (
        ...
        'postal_code', 'unit_type', 'unit_image_thumbnail', 'is_vacant', 'is_verified',
        'maintenance_notes', 'rent_due_reminder', 'agreement_expiry_reminder', 'latitude', 'longitude',
    ...
    fieldsets = (
        ('Basic Info', {
            'fields': ('owner', 'building_name', 'unit', 'unit_type')
        }),
        ('Address', {
