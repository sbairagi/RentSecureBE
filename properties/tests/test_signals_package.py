...
from properties.models import (
    ...
    UnitDocument, UnitImage, PropertyTaxRecord
)
...
class SignalUsageUpdateTest(TestCase):
    def setUp(self):
        self.user = User.objects.create_user(
            username='sigpkg_user', email='spu@test.com',
            password='p', full_name='SPU', phone='+1'
        )
        self.building = Building.objects.create(
            name='SigPkgBldg', address_line='Addr', city='Mumbai',
    ...
    def test_building_creation_updates_usage(self):
        ...
        building = Building.objects.create(
            name='SigPkgBldg2', address_line='Addr2', city='Mumbai',
            state='Maharashtra', country='India', postal_code='400001',
            owner=self.user
        )
    ...
    def test_unit_creation_updates_usage(self):
        ...
        unit = Unit.objects.create(
            building=self.building, unit_number='SPU1',
    ...
    def test_caretaker_creation_updates_usage(self):
        ...
        caretaker = Caretaker.objects.create(
            ...
            name='Test CT', phone='+919999999999',
            email='ct@test.com'
        )

    def test_renter_onboarding_token_generated(self):
        unit = Unit.objects.create(
            building=self.building, unit_number='SPU2',
            rent_amount=Decimal('10000'), security_deposit=Decimal('20000')
        )
        renter = Renter.objects.create(
            unit=unit, full_name='Signal Renter',
            email='sigrenter@test.com', phone='+919876543210',
    ...
    def test_renter_deactivation_triggers_unit_vacant_notification(self):
        unit = Unit.objects.create(
            building=self.building, unit_number='SPU3',
            rent_amount=Decimal('10000'), security_deposit=Decimal('20000')
        )
        renter = Renter.objects.create(
            unit=unit, full_name='Sig Renter Act',
            email='sigact@test.com', phone='+919876543210',
