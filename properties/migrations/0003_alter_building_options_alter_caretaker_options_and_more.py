...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name="end_date",
            field=models.DateField(
                blank=True, help_text="When caretaker ended (null if active)", null=True
            ),
        ),
        migrations.AlterField(
            model_name="caretaker",
        ...
        migrations.AlterField(
            ...
            field=models.TextField(
                blank=True, help_text="Additional notes about caretaker", null=True
            ),
        ),
        migrations.AlterField(
            model_name="caretaker",
        ...
        migrations.AlterField(
            ...
            name="start_date",
            field=models.DateField(
                blank=True, db_index=True, help_text="When caretaker started", null=True
            ),
        ),
        migrations.AlterField(
            model_name="caretaker",
        ...
        migrations.AlterField(
            ...
            name="id_proof",
            field=models.TextField(
                help_text="Government ID proof (Aadhaar, PAN, etc.)", max_length=100
            ),
        ),
        migrations.AlterField(
            model_name="historicalcaretaker",
        ...
        migrations.AlterField(
            ...
            name="notes",
            field=models.TextField(
                blank=True, help_text="Additional notes about the unit", null=True
            ),
        ),
        migrations.AlterField(
            model_name="historicalunit",
        ...
        migrations.AddIndex(
            model_name="caretaker",
            index=models.Index(
                fields=["unit", "start_date"], name="properties__unit_id_2041da_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="unit",
        ...
        migrations.AddIndex(
            model_name="unitdocument",
            index=models.Index(
                fields=["unit", "uploaded_at"], name="properties__unit_id_9df03d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="unitimage",
            index=models.Index(
                fields=["unit", "uploaded_at"], name="properties__unit_id_e0dbd7_idx"
            ),
        ),
    ]
