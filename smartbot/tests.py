...
from smartbot.actions import send_rent_reminder, retry_payout, send_rent_agreement, send_agreement_for_signature
...
class SmartBotActionsTest(TestCase):
    ...
    def test_send_rent_agreement(self, mock_send, mock_gen_pdf, mock_rent_record, mock_renter):
        mock_renter_instance = MagicMock()
        mock_renter_instance.name = 'Test Renter'
        mock_renter.objects.get.return_value = mock_renter_instance
        mock_rent = MagicMock()
    ...
    def test_send_agreement_for_signature_success(self, mock_initiate, mock_gen_pdf, mock_rent_record, mock_renter):
        mock_renter_instance = MagicMock()
        mock_renter_instance.name = 'Test Renter'
        mock_renter.objects.get.return_value = mock_renter_instance
        mock_rent = MagicMock()
